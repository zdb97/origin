...
PlanListToggler.prototype={
	...
	updateView:function(){var t=this.getActiveFilterLinks(),e=this.getActivePlanList();this.$filterLinks.removeClass(this.activeClass),t.addClass(this.activeClass),this.$planLists.removeClass(this.activeClass),e.addClass(this.activeClass),(new $.SwipePlans).showPlanSwipe()},
